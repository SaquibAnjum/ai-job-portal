      ...
      <div className="flex-1 flex items-center justify-center p-4 py-12">
        <div className="w-full max-w-md glass-card p-8 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-2xl space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400">Sign in to access your AI Job Matching Dashboard</p>
          </div>

          {error && (
            <div className="p-3.5 bg-rose-500/10 border border-rose-500/20 rounded-2xl space-y-2 text-xs text-rose-600 dark:text-rose-400 animate-in fade-in">
              ...
              {error.toLowerCase().includes('verify') && (
                <button
                  ...
                  className="w-full py-1.5 px-3 bg-rose-500/20 hover:bg-rose-500/30 text-rose-700 dark:text-rose-300 rounded-xl text-[11px] font-bold transition flex items-center justify-center gap-1 mt-1"
                >
            ...
            <div className="flex items-center justify-between text-xs text-slate-600 dark:text-slate-400">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 rounded border-slate-300 dark:border-slate-800 bg-white dark:bg-slate-950 text-indigo-600 focus:ring-indigo-500"
                />
