  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col justify-between transition-colors duration-300">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
        {/* Search Header */}
        <div className="glass-card p-6 sm:p-8 rounded-3xl border border-slate-200/80 dark:border-slate-800 mb-10 space-y-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white flex items-center gap-2">
                Explore Opportunities <Sparkles className="w-5 h-5 text-indigo-600 dark:text-indigo-400" />
              </h1>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold transition flex items-center gap-2 border ${
                useVectorSearch
                  ? 'bg-purple-100 dark:bg-purple-600/20 text-purple-700 dark:text-purple-300 border-purple-300 dark:border-purple-500/50 shadow-md'
          ...
          <form onSubmit={handleSearchSubmit} className="grid grid-cols-1 sm:grid-cols-4 gap-3">
            ...
            <div className="relative">
              <MapPin className="w-4 h-4 text-slate-400 dark:text-slate-500 absolute left-3 top-3.5" />
              <input
                type="text"
                ...
                className="w-full glass-input rounded-xl pl-9 pr-4 py-2.5 text-xs focus:outline-none disabled:opacity-40"
              />
            </div>
          ...
          {/* Quick Filters */}
          <div className="flex flex-wrap items-center gap-3 text-xs pt-2 border-t border-slate-200 dark:border-slate-800/80">
            <span className="text-slate-600 dark:text-slate-400 font-semibold flex items-center gap-1">
              <Filter className="w-3.5 h-3.5 text-indigo-600 dark:text-indigo-400" /> Work Mode:
            </span>
        ...
        {loading || semanticLoading ? (
          ...
          <div className="glass-card p-12 text-center rounded-3xl border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400">
