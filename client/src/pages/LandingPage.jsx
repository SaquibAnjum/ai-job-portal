...
import { Sparkles, Brain, Cpu, Zap, ArrowRight, CheckCircle2, Search, Target, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col selection:bg-indigo-500 selection:text-white">
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-xs font-semibold mb-8 animate-in fade-in slide-in-from-bottom-2">
            <Sparkles className="w-3.5 h-3.5" /> Next-Generation AI Recruitment Engine
          </div>

          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight max-w-5xl mx-auto leading-tight mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              to="/jobs"
              className="w-full sm:w-auto px-8 py-4 glass-card hover:bg-slate-900 text-slate-200 rounded-2xl font-bold text-sm border border-slate-800 transition-all hover:border-slate-700 flex items-center justify-center gap-2"
            >
              <Search className="w-4 h-4 text-indigo-400" /> Explore Jobs
            </Link>
          </div>

          {/* Interactive Feature Teaser Card */}
          <div className="mt-16 max-w-4xl mx-auto glass-card rounded-3xl p-6 sm:p-8 border border-slate-800/80 shadow-2xl text-left">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4 mb-6">
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 rounded-full bg-rose-500"></div>
                <div className="w-3 h-3 rounded-full bg-amber-500"></div>
                <div className="w-3 h-3 rounded-full bg-emerald-500"></div>
                <span className="text-xs font-semibold text-slate-400 ml-2">Live AI Match Simulator</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
              <div className="p-4 rounded-xl bg-slate-950/60 border border-slate-800 space-y-2">
                <p className="font-bold text-slate-300">Target Candidate: Alex Mercer</p>
                <p className="text-slate-400">Skills: React.js, Node.js, Express, MongoDB, Tailwind CSS</p>
                <p className="text-slate-400">Experience: 4 Years Full-Stack Engineering</p>
              </div>
              <div className="p-4 rounded-xl bg-indigo-950/30 border border-indigo-500/30 space-y-2">
                <p className="font-bold text-indigo-300 flex items-center gap-1.5">
                  <Brain className="w-4 h-4 text-indigo-400" /> Gemini Match Output
                </p>
                <p className="text-slate-300">Reasoning: Exceptional overlap with Senior MERN Stack role. High technical proficiency.</p>
                <div className="flex flex-wrap gap-1 pt-1">
                  <span className="bg-emerald-500/20 text-emerald-300 px-2 py-0.5 rounded font-mono">Matched: React, Node, Express</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card p-8 rounded-3xl border border-slate-800 space-y-4">
              ...
              <h3 className="text-lg font-bold text-white">AI Resume Parser</h3>
            ...
            <div className="glass-card p-8 rounded-3xl border border-slate-800 space-y-4">
              ...
              <h3 className="text-lg font-bold text-white">Smart Match Scoring</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div className="glass-card p-8 rounded-3xl border border-slate-800 space-y-4">
              ...
              <h3 className="text-lg font-bold text-white">AI Interview Questions</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
