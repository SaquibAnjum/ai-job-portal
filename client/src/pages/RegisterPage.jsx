...
import { Sparkles, Mail, Lock, User, UserCheck, Briefcase, AlertCircle, Eye, EyeOff, CheckCircle2, ShieldCheck, Loader2 } from 'lucide-react';
...
const RegisterPage = () => {
  ...
  const getPasswordStrength = (pass) => {
    ...
    if (score <= 2) return { score: 33, label: 'Weak', color: 'bg-rose-500', text: 'text-rose-400' };
    if (score <= 4) return { score: 66, label: 'Medium', color: 'bg-amber-500', text: 'text-amber-400' };
      ...
      <div className="flex-1 flex items-center justify-center p-4 py-12">
        <div className="w-full max-w-md glass-card p-8 rounded-3xl border border-slate-800 shadow-2xl space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-slate-400">Join NexHire.AI for AI-powered recruitment & job matching</p>
          </div>

          {(error || validationError) && (
            <div className="p-3 bg-rose-500/10 border border-rose-500/20 rounded-xl flex items-center gap-2 text-xs text-rose-400 animate-in fade-in">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-slate-950/80 border rounded-xl pl-9 pr-10 py-2.5 text-xs text-white focus:outline-none ${
